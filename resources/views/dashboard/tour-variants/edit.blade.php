            ...
            <div class="col-12">
                <div class="card main-card">
                    ...
                    <div class="card-body main-card-body">
                        <form action="{{ route('admin.tour-variants.update', $variant->id) }}" method="POST"
                                ...
                                <div class="section-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror"
                                            id="title" name="title" value="{{ old('title', $variant->title) }}" required>
                                        @error('title')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror"
                                            ...
                                            rows="4">{{ old('description', $variant->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div>
                                                    <img src="{{ asset('uploads/tour-variants/' . $variant->image) }}"
                                                        alt="{{ $variant->title }}" class="img-thumbnail"
                                ...
                                <div class="section-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number"
                                                class="form-control @error('additional_duration') is-invalid @enderror"
                                                id="additional_duration" name="additional_duration"
                                                value="{{ old('additional_duration', $variant->additional_duration) }}"
                                                min="0">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select
                                                class="form-select @error('additional_duration_type') is-invalid @enderror"
                                                id="additional_duration_type" name="additional_duration_type">
                                                <option value="days" {{ old('additional_duration_type', $variant->additional_duration_type) == 'days' ? 'selected' : '' }}>Days
                                                </option>
                                                <option value="hours" {{ old('additional_duration_type', $variant->additional_duration_type) == 'hours' ? 'selected' : '' }}>Hours
                                                </option>
                                            </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" step="0.01"
                                                ...
                                                value="{{ old('additional_price', $variant->additional_price !== null ? (float) $variant->additional_price : '') }}"
                                                min="0">
