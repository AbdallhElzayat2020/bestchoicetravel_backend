                                ...
                                <div class="section-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div id="tourImagesContainer">
                                            <p class="text-muted mb-0 text-center py-3">No gallery images added yet. Click
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                id="duration" name="duration" value="{{ old('duration', 1) }}"
                                                min="1" required>
                                            @error('duration')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select @error('duration_type') is-invalid @enderror"
                                                ...
                                                <option value="days"
                                                    {{ old('duration_type') == 'days' ? 'selected' : '' }}>Days</option>
                                                <option value="hours"
                                                    {{ old('duration_type') == 'hours' ? 'selected' : '' }}>Hours</option>
                                            </select>
                                            @error('duration_type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number"
                                                ...
                                                name="price" value="{{ old('price', 0) }}" step="0.01"
                                                min="0" required>
                                            @error('price')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ old('price_before_discount') }}" step="0.01"
                                                    min="0">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ old('price_after_discount') }}" step="0.01"
                                                    min="0">
                            ...
                            <div class="section-card">
                                ...
                                <div class="section-body">
                                    ...
                                    <div id="tourDaysContainer">
                                        <p class="text-muted mb-0 text-center py-4">No tour days added yet. Click "Add Day"
                            ...
                            <div class="section-card">
                                ...
                                <div class="section-body">
                                    <p class="text-muted mb-3">Select available variants to add to this tour. You can
                                        manage variants from <a href="{{ route('admin.tour-variants.index') }}"
                                            target="_blank" class="text-primary">Tour Variants</a> page.</p>
                                ...
                                <div class="section-body">
                                    ...
                                    <div id="seasonalPricesContainer">
                                        <p class="text-muted mb-0 text-center py-4">No seasonal prices added yet. Click
                                            "Add Seasonal Price" to add pricing seasons.</p>
                                    </div>
                                </div>
                            </div>
