...
<style>
    ...
    .section-header.pricing::before { background: linear-gradient(180deg, #43e97b 0%, #38f9d7 100%); }
    .section-header.settings::before { background: linear-gradient(180deg, #fa709a 0%, #fee140 100%); }
    .section-header.days::before { background: linear-gradient(180deg, #30cfd0 0%, #330867 100%); }
    .section-header h6 {
        margin: 0;
        font-weight: 600;
        font-size: 1.1rem;
    ...
    .section-header.pricing i { color: #43e97b; }
    .section-header.settings i { color: #fa709a; }
    .section-header.days i { color: #30cfd0; }
    .section-body {
        padding: 1.75rem;
        background: #1e2130;
    }
                    ...
                    <div class="card-body main-card-body">
                        <form action="{{ route('admin.tours.store') }}" method="POST" enctype="multipart/form-data" id="tourForm">
                                ...
                                <div class="section-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select @error('cruise_group_id') is-invalid @enderror" id="cruise_group_id" name="cruise_group_id">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select @error('cruise_experience_id') is-invalid @enderror" id="cruise_experience_id" name="cruise_experience_id">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <small class="text-muted">Please select a country first</small>
                                            @error('state_id')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug"
                                            value="{{ old('slug') }}" placeholder="Auto-generated from title if left empty">
                                ...
                                <div class="section-body">
                                    <div class="mb-4">
                                        ...
                                        <input type="file" class="form-control @error('cover_image') is-invalid @enderror" id="cover_image" name="cover_image"
                                            accept="image/*">
                                        <small class="text-muted">Recommended size: 1200x600px. Max size: 2MB</small>
                                        @error('cover_image')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted d-block mb-3">Add multiple images for the tour gallery</small>
                                    ...
                                    <div id="offerFields" style="display: none;">
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" class="form-control @error('price_before_discount') is-invalid @enderror" id="price_before_discount" name="price_before_discount"
                                                    value="{{ old('price_before_discount') }}" step="0.01" min="0">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" class="form-control @error('price_after_discount') is-invalid @enderror" id="price_after_discount" name="price_after_discount"
                                                    value="{{ old('price_after_discount') }}" step="0.01" min="0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="date" class="form-control @error('offer_start_date') is-invalid @enderror" id="offer_start_date" name="offer_start_date"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="date" class="form-control @error('offer_end_date') is-invalid @enderror" id="offer_end_date" name="offer_end_date"
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            ...
                                                                            <div class="d-flex gap-3 mt-2">
                                                                                ...
                                                                                @if($variant->additional_price > 0)
                                                                                    <small class="text-muted">
                                                                                        <i class="ti ti-currency-dollar"></i> +${{ number_format($variant->additional_price, 2) }}
                                                                                    </small>
                                                                                @endif
                                                                            </div>
                                                                        </div>
                            ...
                            <div class="section-card">
                                ...
                                <div class="section-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <p class="text-muted mb-0">Add seasonal pricing with different rates for different months (e.g., Summer/Winter prices)</p>
...
@push('js')
    <script>
        ...
        console.log('=== TOURS CREATE PAGE ===');
        console.log('jQuery available:', typeof $ !== 'undefined');
        console.log('Summernote available:', typeof $.fn.summernote !== 'undefined');

        $(document).ready(function() {
            // Debug: Check if elements exist
            console.log('Category select exists:', $('#cruise_group_id').length);
            ...
            $('#cover_image').change(function(e) {
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        $('#coverImagePreview').html('<img src="' + e.target.result + '" class="img-thumbnail rounded" style="max-width: 300px; max-height: 200px; border: 2px solid #3a3d4a;">');
                    };
            ...
            const selectedCruiseExperienceId = @json(old('cruise_experience_id'));
            ...
            if ($('#cruise_group_id').val()) {
                loadCruiseExperiences($('#cruise_group_id').val(), selectedCruiseExperienceId);
            }
            ...
            $('#addImageBtn').click(function() {
                ...
                `;
                // Remove the placeholder message if exists
            ...
            $(document).on('click', '.removeImageBtn', function() {
                ...
                if ($('#tourImagesContainer .image-item').length === 0) {
                    $('#tourImagesContainer').html('<p class="text-muted mb-0 text-center py-3">No gallery images added yet. Click "Add Image" to add images.</p>');
                }
            });
            ...
            $(document).on('change', '.image-input', function(e) {
                ...
                if (file) {
                    const reader = new FileReader();
                    reader.onload = function(e) {
                        preview.html('<img src="' + e.target.result + '" class="img-thumbnail rounded" style="max-width: 200px; max-height: 150px; border: 2px solid #3a3d4a;">');
                    };
                    reader.readAsDataURL(file);
                } else {
                    preview.html('');
            ...
            $('#addDayBtn').click(function() {
                const dayHtml = `
                    <div class="card mb-3 day-item" data-day-index="${dayCounter}" style="border: 1px solid #e0e0e0; border-radius: 8px;">
                        <div class="card-header d-flex justify-content-between align-items-center" style="background: #f8f9fa; border-bottom: 1px solid #e0e0e0;">
                            <h6 class="mb-0">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" class="form-control day-number" name="tour_days[${dayCounter}][day_number]" value="${dayCounter}" min="1" required>
                                </div>
                                <div class="col-md-9 mb-3">
                                    <label class="form-label">Day Title <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control day-title" name="tour_days[${dayCounter}][day_title]" placeholder="e.g., Day ${dayCounter}: Arrival in Cairo" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Details</label>
                                <textarea class="form-control summernote-day" name="tour_days[${dayCounter}][details]" rows="5"></textarea>
                            </div>
                        </div>
                    </div>
                `;
            ...
            $(document).on('click', '.removeDayBtn', function() {
                ...
                // Show placeholder if no days left
                if ($('#tourDaysContainer .day-item').length === 0) {
                    $('#tourDaysContainer').html('<p class="text-muted mb-0 text-center py-4">No tour days added yet. Click "Add Day" to add itinerary days.</p>');
                }
            });
            ...
            $(document).on('click', '.removeVariantBtn', function() {
                ...
                // Show placeholder if no variants left
                if ($('#tourVariantsContainer .variant-item').length === 0) {
                    $('#tourVariantsContainer').html('<p class="text-muted mb-0 text-center py-4">No variants added yet. Click "Add Variant" to add optional add-ons.</p>');
                }
            });
            ...
            $(document).on('click', '.removeSeasonalPriceBtn', function() {
                ...
                // Show placeholder if no seasonal prices left
                if ($('#seasonalPricesContainer .seasonal-price-item').length === 0) {
                    $('#seasonalPricesContainer').html('<p class="text-muted mb-0 text-center py-4">No seasonal prices added yet. Click "Add Seasonal Price" to add pricing seasons.</p>');
                }
            });
            ...
            $(document).on('click', '.addPriceItemBtn', function(e) {
                ...
                const itemIndex = `new-${priceItemCounter[seasonalPriceIndex]}`;
                ...
                if (!container || container.length === 0) {
                    container = $(this).siblings('.price-items-container');
                }
