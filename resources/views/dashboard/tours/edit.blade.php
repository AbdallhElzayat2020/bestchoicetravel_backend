                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select @error('cruise_group_id') is-invalid @enderror"
                                                ...
                                                @foreach ($cruiseGroups as $cruiseGroup)
                                                    <option value="{{ $cruiseGroup->id }}" {{ old('cruise_group_id', $selectedCruiseGroupId) == $cruiseGroup->id ? 'selected' : '' }}>
                                                        {{ $cruiseGroup->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-select @error('cruise_experience_id') is-invalid @enderror"
                                                ...
                                                @foreach ($cruiseExperiences as $experience)
                                                    <option value="{{ $experience->id }}" {{ old('cruise_experience_id', $tour->cruise_experience_id) == $experience->id ? 'selected' : '' }}>
                                                        {{ $experience->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="number" class="form-control @error('price') is-invalid @enderror"
                                                id="price" name="price"
                                                value="{{ old('price', $tour->price !== null ? (float) $tour->price : '') }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ old('price_before_discount', $tour->price_before_discount !== null ? (float) $tour->price_before_discount : '') }}"
                                                    step="0.01" min="0">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ old('price_after_discount', $tour->price_after_discount !== null ? (float) $tour->price_after_discount : '') }}"
                                                    step="0.01" min="0">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-4 mb-2">
                                                                                            ...
                                                                                            <input type="number"
                                                                                                ...
                                                                                                value="{{ $item->price_value !== null ? (float) $item->price_value : '' }}"
