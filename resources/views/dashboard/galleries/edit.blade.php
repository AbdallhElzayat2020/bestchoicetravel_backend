                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        @if($gallery->cover_image)
                            <div class="mt-2">
                                <img src="{{ asset('uploads/galleries/' . $gallery->cover_image) }}" alt="{{ $gallery->title }}"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                            <option value="active" {{ old('status', $gallery->status) === 'active' ? 'selected' : '' }}>Active
                            </option>
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <div class="form-check mt-2">
                            <input class="form-check-input" type="checkbox" value="1" name="show_on_homepage"
                                id="show_on_homepage" {{ old('show_on_homepage', $gallery->show_on_homepage) ? 'checked' : '' }}>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" name="published_at"
                            value="{{ old('published_at', optional($gallery->published_at)->format('Y-m-d')) }}"
